// Shared color configuration for web and mobile applications
// This ensures consistent branding across all platforms
...
export const COLORS = {
  ...
  white: '#ffffff',
  gray: BRAND_COLORS.text.secondary,
  lightGray: BRAND_COLORS.background.default,
