...
const HeroSection = () => {
  return (
    <div className="w-screen relative left-[50%] -ml-[50vw] pt-20 pb-20 bg-gradient-to-br from-[#022C43] to-[#055A87] text-white text-center">
      <ContentContainer>
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-6 justify-center flex-wrap items-start">
            ...
            <div className="flex flex-col items-center opacity-50 cursor-not-allowed">
              <div className="relative w-40 md:w-44 h-12 md:h-14 rounded-lg overflow-hidden shadow-md flex items-center justify-center">
                <Image
              ...
              <p className="mt-2 opacity-70 text-sm text-center text-white">
                Uskoro dostupno
              </p>
            </div>
          </div>
