...
// Serve uploads from the local uploads folder in both development and production
app.use('/uploads', express.static(path.join(__dirname, 'uploads')));
console.log('📁 Serving uploads from server/uploads');
...
app.use('/api/daije', require('./routes/daijeRoutes'));
